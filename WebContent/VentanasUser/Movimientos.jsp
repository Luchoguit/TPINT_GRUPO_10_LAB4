...
<div class="table-container">
    ...
    <div class="table-header">
        ...
        <div><strong>N�mero de Cuenta:</strong> <%= cuentaSeleccionada.getNumeroCuenta() %></div>
    </div>
    ...
    <form method="get" action="ServletMovimientosCuenta" class="filter-container">
        ...
        <select name="tipoMovimiento" id="tipoMovimiento">
            ...
            <option value="2">Alta de Pr�stamo</option>
            <option value="3">Pago de Pr�stamo</option>
